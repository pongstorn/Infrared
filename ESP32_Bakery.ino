...
String setting_url = "https://iotlogger.cpf.co.th/process/bnp/logger.php"; 
String setting_freq;
...
void loop() {
  ...
  HTTPDATA = setting_id + "00012710";
  //https://iotlogger.cpf.co.th/feedcenter/logger.php?data=0002102320a0
  //Humidity
  //https://iotlogger.cpf.co.th/feedcenter/logger.php?data=000200231851
  //Temperature
...
//  Serial.println(setting_url + "?data=" + HTTPDATA);
  ...
  if(count>19)
  {
    ...
    if (timer.isReady()) {                    // Check is ready a second timer
        Serial.println("Called every 60 sec");
        // Do something ...
...
//              String test = setting_url + "?data=" + HTTPDATA;
  ...
  temp[count] = mlx.readObjectTempC();
  
  delay(400);
//  Serial.println("Adafruit MLX90614 test");

//  Serial.print("Ambient = "); Serial.print(mlx.readAmbientTempC());
  Serial.print(count);  Serial.print(" "); Serial.print(temp[count]); Serial.println("*C");
...
display.println(String(temp[count], 1));
display.display();
